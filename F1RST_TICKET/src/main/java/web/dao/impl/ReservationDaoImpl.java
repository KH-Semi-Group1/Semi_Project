...
//		sql += " WHERE userid = ?";
	...
	@Override
	public List<Reservation> selectAllRsPay(Connection conn, Paging paging, User user, ReservationPay rsPay) {

		String sql = "";
		sql += "SELECT rownum, R.resno, R.userid, P.mcno, P.mcname";
		sql += " FROM reservation R, reservationpay P, usertable U";
		sql += " WHERE rownum BETWEEN ? AND ?";
		sql += " AND R.resno = P.resno";
